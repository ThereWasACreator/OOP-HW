...
int main() {
	...
	entries.reserve(3);
	entries.emplace_back(Student("Иванов", "Иван", "Иванович", 21, 3, "КВБО-09-21"));
	entries.emplace_back(Student("Петров", "Пётр", "Петрович", 18, 1, "КВБО-08-21"));
	entries.emplace_back(Student("Ыунов", "Ыун", "", 45, -156, "КВБО-06-19"));
	printEntries(entries);
